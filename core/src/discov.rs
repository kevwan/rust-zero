...
impl ServiceRegistry {
    ...
    pub fn publish(
        ...
        let added = {
            ...
            let references = endpoints.entry(endpoint.clone()).or_default();
            *references += 1;
            *references == 1
        };
...
struct RegistryState {
    services: Mutex<HashMap<String, BTreeMap<String, usize>>>,
...
impl ServiceLease {
    ...
    pub fn release(&mut self) {
        ...
        let removed = {
            ...
            let Some(references) = endpoints.get_mut(&self.endpoint) else {
                return;
            };
...
#[cfg(test)]
mod tests {
    use super::{DiscoveryError, ServiceEvent, ServiceRegistry};
